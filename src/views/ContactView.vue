<template>
  <div class="contact-container">
    ...
    <div class="right-col">
      ...
      <h1>Contact us</h1>
      <p>Planning to get a car soon? contact us to find best deals for your car.</p>
      <form id="contact-form" method="post" @submit.prevent="submitForm">
        <label for="name">Full name</label>
        <input type="text" id="name"  placeholder="Your Full Name" required>
        <label for="email">Email Address</label>
        <input type="email" id="email"  placeholder="Your Email Address" required>
        <label for="message">Message</label>
        <textarea rows="6" placeholder="Your Message" id="message"  required></textarea>
